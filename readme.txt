=== Smart Quote Fixer ===
Contributors: SaltedStone
Tags: smart quotes, curly quotes, curly, quotes, content_save_pre, title_save_pre, smart quote fix, typographers quotes, typographer quotes, typographer
...
Not only does this plugin fix smart quotes, it also replaces the (tm) (c) and (r) symbols into proper HTML entities.
...
1. Activate Smart Quote Fixer through the 'Plugins' menu in WordPress
1. That's it. It will now automatically remove smart quotes from post content and titles.
